...
# ------------------------------------------------
# Start coding below!
print("DAILY SALES, ORIGINAL LIST:")
print()
print(daily_sales)
...
print()
print()
print("DAILY SALES REPLACED with \"^\" :")
print()
...
print()
print()
print("DAILY TRANSACTIONS (TURNED STRING INTO LIST):")
print()
print(daily_transactions)

daily_transactions_split = []

daily_transactions_split = [items.split("^") for items in daily_transactions]
...
print()
print()
print("TRANSACTIONS CLEAN (USED STRIP METHOD TO REMOVE ANY REMAINIG WHITE SPACE):")
print()
