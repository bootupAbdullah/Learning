# 2. Count X
# Next, we are going to try something a bit different. This time we are going to 4
# count the number of occurrences of a certain letter within a string. Our function will 
# accept a parameter for a string and another for the character which we are going to count. 
# For example, providing the word "mississippi" and the character 's' would result in an answer of 4. 
# 
# 
